...
submit.addEventListener("click", ()=>{
    if (form.elements.name.value == "") form.elements.name.style.borderColor = "red";
    else form.elements.name.style.borderColor = "black";
    if (form.elements.lastname.value == "") form.elements.lastname.style.borderColor = "red";
    else form.elements.lastname.style.borderColor = "black";
    if (form.elements.pass.value == "") form.elements.pass.style.borderColor = "red";
    else form.elements.pass.style.borderColor = "black";
    if (form.elements.name.value != "" && form.elements.lastname.value != "" && form.elements.pass.value != "") {
        ...
        Object.defineProperty(obj, "pass", {
            value: form.elements.pass.value
        });
        Object.defineProperty(obj, "role", {
            value: form.elements.role.value
        });
        main.style.display = "none";
        if (obj.role == "viewer") viewerDiv.style.display = "block";
        else if (obj.role == "moderator") moderatorDiv.style.display = "block";
    }
    console.log(obj);
});
